...
public class AppConfig {
    ...
    private void loadRouter() {
        ...
        this.router.addHandler(Method.GET, new Path("/movies/{mid}/reviews/{rid}"), new GetUserReviewHandler());
        this.router.addHandler(Method.GET, new Path("/users/{uid}/reviews"), new GetUserReviewHandler());
        this.router.addHandler(Method.GET, new Path("/users/{uid}/reviews/{rid}"), new GetUserReviewHandler());
        this.router.addHandler(Method.GET, new Path("tops/ratings"), new GetUserReviewHandler());
    }
